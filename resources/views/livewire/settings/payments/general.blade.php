<div
    x-data="{
        options: ['general', 'stripe', 'notchpay'],
...
>
        ...
        <div>
            ...
            <div class="hidden sm:block">
                <nav class="-mb-px flex space-x-8">
                    ...
                    <button @click="currentTab = 'notchpay'" type="button" class="whitespace-no-wrap pb-4 px-1 border-b-2 border-transparent font-medium text-sm leading-5 text-secondary-500 hover:text-secondary-700 hover:border-secondary-300 dark:text-secondary-400 dark:hover:text-secondary-500 dark:hover:border-secondary-400 focus:outline-none" :class="{ 'border-primary-500 text-primary-600 focus:text-primary-800 focus:border-primary-700': currentTab === 'notchpay' }">
                        {{ __('Notch Pay') }}
                    </button>
    ...
    <div class="mt-10">
        ...
        <div x-cloak x-show="currentTab === 'notchpay'">
            <livewire:settings.payments.notch-pay />
        </div>
    </div>
